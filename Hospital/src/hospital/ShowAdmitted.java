...
public class ShowAdmitted extends javax.swing.JFrame {
    Connection con=null;
    ResultSet rs=null;
    ...
    private void Get_Data(){
       ...
       String sql="Select PatientRegistration.PatientID as 'Patient ID',PatientRegistration.PatientName as 'Patient Name',PatientRegistration.Gen as 'Gender',PatientRegistration.BG as 'Blood Group',Disease,AdmitDate as 'Admit Date',Room.RoomNo as 'Room No',Room.RoomType as \"Room Type\",patientmedicine.Medicine as \"Medicine\",patientlab.blood_pressure as\"Blood Pressure\",patientlab.body_temperature as\"Blood Temperature\" ,patientlab.blood_sugar_level as\"Surag Level\",patientlab.heart_rate as\"Heart Rate\",patientlab.diagnosis as\"Diagnosis\",DoctorName as 'Doctor Name',AdmitPatient_Room.AP_Remarks as 'Remarks' from Room,Doctor,PatientRegistration,AdmitPatient_Room,patientmedicine,patientlab where Room.RoomNo=AdmitPatient_Room.RoomNo and Doctor.DoctorID=AdmitPatient_Room.DoctorID and PatientRegistration.PatientID=AdmitPatient_Room.PatientID and patientmedicine.PatientID=AdmitPatient_Room.PatientID and patientlab.PatientID=AdmitPatient_Room.PatientID order by admitdate;";
...
//                jTable1MouseClicked(evt);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ShowAdmitted.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ShowAdmitted().setVisible(true);
            }
        });
    }
