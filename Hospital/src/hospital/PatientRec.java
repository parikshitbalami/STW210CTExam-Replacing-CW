        ...
        try{
            ...
            if(rs.next()){
                this.hide();
                	...
                	MedicineReg frm = new MedicineReg("");
                	 frm.setVisible(true);
...
//                     String add7=rs.getString("Medicine ");
