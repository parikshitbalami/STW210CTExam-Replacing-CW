...
public class Patient_Admit_Rec extends javax.swing.JFrame {
Connection con=null;
ResultSet rs=null;
PreparedStatement pst=null;
 ...
 private void Get_Data(){
         String sql="Select PatientRegistration.PatientID as 'Patient ID',PatientRegistration.PatientName as 'Patient Name',PatientRegistration.Gen as 'Gender',PatientRegistration.BG as 'Blood Group',Remarks from Patientregistration";
         try{
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        try{
            ...
            if(rs.next()){
                this.hide();
                Assign_doctor frm = new Assign_doctor();
                frm.setVisible(true);
